...
//Code here
favoriteThings.location = "Blyxie";
...
//Code Here
myPhone = new Phone("thisBrand", "thisModel", "lots", "orange", 76);
yourPhone = new Phone("yourBrand", "yourModel", "little", "blue", 13);
theirPhone = new Phone("theirBrand", "theirModel", "some", "pink", 12);
...
//Code Here
const myFirstVehicle = new Vehicle(100, "hot pink", 23);
...
//Code Here
let myFirstMotocycle = new Motorcycle(3, "green", 3456, "makeExample", true);

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/

myFirstMotocycle.move(500);
...
//Code Here
const myFirstBoat = new Boat(6, "blue", 123, "Sick Name", "big boat", false);
